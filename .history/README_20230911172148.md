...
![Chart visualizes average installs, reviews, and ratings among category](./img/Plot-8-Bar-plot-visualizes-the-relationship-between-price-ranges-and-Installs.png)
