...
![CBar plot visualize the relationship between rating ranges and Installs](./img/Plot-9-Chart-visualizes-average-installs-reviews-and-ratings-among-category.png)
